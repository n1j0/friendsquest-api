...
export class UserSeeder extends Seeder {
    async run(em: EntityManager, context: Dictionary): Promise<void> {
        ...
        context.eliburgi = em.create(User, {
        ...
        context.marcel98 = em.create(User, {
        ...
        context.bjelline = em.create(User, {
        ...
        context.dominik = em.create(User, {
